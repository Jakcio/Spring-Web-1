...
public class TrelloMapper {
    ...
    public List<TrelloBoard> mapToBoards(final List<TrelloBoardsDto> trelloBoardDto) {
    ...
    public List<TrelloBoardsDto> mapToBoardsDto(final List<TrelloBoard> trelloBoards) {
        return trelloBoards.stream()
                .map(trelloBoard ->
                        new TrelloBoardsDto(trelloBoard.getId(), trelloBoard.getName(), mapToListDto(trelloBoard.getLists())))
                .collect(toList());
